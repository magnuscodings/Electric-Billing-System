...
@else
    <button @if ($id) id="{{ $id }}" @endif
        ...
        @if ($dataDrawerTarget) data-drawer-target="{{ $dataDrawerTarget }}" @endif
        @if ($dataDrawerShow) data-drawer-show="{{ $dataDrawerShow }}" @endif
        @if ($ariaControls) aria-controls="{{ $ariaControls }}" @endif
        @if ($dataDrawerPlacement) data-drawer-placement="{{ $dataDrawerPlacement }}" @endif>
        {{ $text }}
    </button>
@endif
